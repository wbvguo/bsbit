...
- License hashes bind canonical UTF-8 text with LF line endings. A Windows
  checkout may contain equivalent CRLF text; assembly normalizes it to LF,
  while malformed lone carriage returns and all other byte changes fail.
