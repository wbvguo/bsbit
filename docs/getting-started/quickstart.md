...
??? output-behavior "Output behavior"
    ...
    ⚠️ If a file already exists at the specified output path, it will be automatically overwritten.
...
Create the FASTA index is recommended before calling.
...
[Usage: Call methylation](../guides/methylation-calling.md)
