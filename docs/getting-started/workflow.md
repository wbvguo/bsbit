...
| Call [methylation](../guides/methylation-calling.md) or [SNVs](../guides/variant-calling.md) | `bsbit call` | Prepared BAM and matching reference | Methylation output and/or VCF |
