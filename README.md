...
- Bit-parallel backend acceleration. Myers bit-vector filters use portable
  scalar code as their fallback and correctness reference. Release x86
  backends are SSE2 (128-bit), SSE4.2-qualified byte SIMD (128-bit), AVX2
  (256-bit), and AVX-512BW (512-bit).
