...
pub const MAX_EDIT_DISTANCE: u8 = 5;

/// Shortest read accepted by the mapping core.
pub const MIN_READ_BASES: usize = 3;

/// Largest read accepted by the fixed verification buffers.
pub const MAX_READ_BASES: usize = 3 * 64;

/// Maximum number of candidates processed by one vectorized verifier call.
pub(crate) const VERIFICATION_BATCH: usize = 64;
