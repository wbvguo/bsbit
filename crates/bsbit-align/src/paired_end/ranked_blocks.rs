//! Rarity-ranked exact-block candidate construction.
//!
...
use crate::read_mapping::ReadCandidate;
...
#[derive(Clone, Copy)]
pub(super) struct RankedBlockSeed {
...
#[derive(Clone, Copy)]
pub(super) struct RankedBlockSelection {
    pub(super) retained_hits: u64,
...
fn ranked_block_seed_for_range(
    ...
    Ok(Some(RankedBlockSeed {
        ...
        proof_mask: 1_u16 << block_ordinal,
    }))
}
