...
mod tests {
    ...
    #[test]
    fn ignore_orphan_filters_only_improper_paired_records() {
        assert!(!should_ignore_orphan(0, true));
        assert!(!should_ignore_orphan(0x1 | 0x2, true));
        assert!(should_ignore_orphan(0x1, true));
        assert!(!should_ignore_orphan(0x1, false));
    }
