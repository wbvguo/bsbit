...
/// only through create-only staged file lifecycles.
///
/// # Errors
///
/// Returns a stable syntax/unsupported error (exit 2) or an operational error
/// (exit 1). Operational error returns never create a new final artifact.
pub fn run(
