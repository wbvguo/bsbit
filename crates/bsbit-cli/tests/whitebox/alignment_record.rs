...
use super::{
    AlignmentRecordComposer, RecordBuildError as AlignmentRecordError, append_u64,
...
fn direct_single_fast_path_accepts_certified_distance_two_and_rejects_shifted_gap_ties() {
    ...
    let mut tie_composer = AlignmentRecordComposer::new();
    assert!(
        !tie_composer
            .try_push_ungapped_single(
                &tie_reference,
...
fn header_bytes_are_exact_ordered_and_bounded() {
    ...
    assert_eq!(
        ...
        concat!(
            "@HD\tVN:1.6\tSO:unsorted\n@SQ\tSN:alpha\tLN:4\tM5:f1f8f4bf413b16ad135722aa4591043e\n@SQ\tSN:beta\tLN:2\tM5:8cc2e7240164328fdc3f0e5e21032c56\n@PG\tID:bsbit\tPN:bsbit\tVN:",
